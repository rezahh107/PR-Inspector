...
## v1.12 review-package assembly

The deterministic in-process assembler does not depend on cryptographic signing, HMAC, keys, capability tokens, or resistance to a malicious caller controlling the same Python process. Optional strict-profile governance evidence remains separate from the technical package-assembly authority.
