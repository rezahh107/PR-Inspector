...
v1.11.0 preserves the external Coverage bootstrap boundary from v1.10.0 without broadening its authority. The structured personal minimum-security profile is evaluated separately by the canonical PR Inspector decision projection; it does not authorize Coverage proof credit, trusted ingestion, repository settings, approval, or merge.
