...
from .derived_outputs import MANIFEST_NAME, PROFILE_COMMANDS_NAME, PROJECTION_NAME, PROMPT_NAME
...
def official_owner_profile_commands(value: VerifiedReviewCompletion) -> str:
    if not is_verified_review_completion(value):
        raise CompletionError("official profile guidance requires verified completion")
