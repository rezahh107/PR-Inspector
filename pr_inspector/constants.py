...
SUPPORTED_PROTOCOL_VERSIONS = frozenset({"v1.12.0", "v1.13.0", "v1.13.1"})
...
DOMAIN_SPECIALIST_REQUIRED = {
    ...
    "REGULATED_DATA", "CREDENTIAL_ACCESS", "CRYPTOGRAPHY",
    "DESTRUCTIVE_CHANGE", "DATABASE_MIGRATION", "PRODUCTION_INFRASTRUCTURE",
    "BACKUP_RECOVERY", "SECURITY_BOUNDARY", "SUPPLY_CHAIN", "SAFETY_CRITICAL",
}
